...
<script>
  export default {
    ...
    methods: {
      ...
      isValid(e){
        let input = e.target
        if (input.value.trim() != "" && input.value.trim() != 0 && input.value.length > 1) {
